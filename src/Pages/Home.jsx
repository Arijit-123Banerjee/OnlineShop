  ...
  return (
    <>
      ...
      <section className="h-screen flex items-center mt-32 flex-col  ">
        <div className="gap-3">
          <h1 className="text-8xl font-bold font-work-sans text-stone-700 max-md:text-5xl">
            UNBELIEVABLE
          </h1>
          <p className="text-4xl text-center font-bold text-stone-700 max-md:text-2xl">
            SPEED. COMFORT.
          </p>
        </div>
        <Crousel />
      ...
      <section className="h-screen bg-gray-200 mt-24">
        <AirProX4 />
      </section>
    </>
  );
